...
function tbd(model, submission, onAccept) {
...
export class TaskModel {
  ...
  submit(submission) {
    tbd(this, submission, (model) => model.audioPlayer.playFeedback());
  }
...
export class TaskModelWithoutFeedback {
  ...
  submit(submission) {
    tbd(this, submission, (model) =>
      model.observer.notifyThatTaskIsReadyToEnd()
    );
  }
